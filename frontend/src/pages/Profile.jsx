  ...
  return (
    <div className='flex flex-col w-full md:flex-row h-full justify-center items-center md:items-start md:h-[500px]   mt-[100px] '>
        <div className='w-[30%]  border-red-400 flex  justify-center items-top mt-5 '>
            ...
            <button onClick={handleLogout} class="bg-red-500 text-center mt-2 hover:bg-red-600 text-white font-semibold py-1 px-4 rounded-xl shadow-md transition-all duration-300 ease-in-out">
              Logout
            </button>
            </div>
        </div>
