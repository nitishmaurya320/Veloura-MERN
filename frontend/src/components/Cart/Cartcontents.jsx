  ...
  return (
    <div>
      {cart.products.map((product, index) => (
        <div
          key={index}
          className="flex w-full  rounded   px-1 border-gray-400 border justify-between mb-2"
        >
          ...
          <div className="flex flex-col ml-4 md:text-[15px] text-[13px]  w-[60%]">
            ...
            <div className="flex items-center  justify-self-start md:text-[15px] text-[12px]  h-[25px] m-1">
              <div
                ...
                className="md:w-[25px] md:h-[25px] w-[20px] border h-[20px] cursor-pointer flex justify-center items-center  text-xl"
              >
                -
              </div>
              ...
              <div
                ...
                className="md:w-[25px] w-[20px] md:h-[25px] h-[20px] border  cursor-pointer  flex justify-center items-center  text-xl"
              >
                +
              </div>
            </div>
          ...
          <div className=" w-[20%] md:text-[15px] text-[12px] flex flex-col items-end px-2">
            ...
            <MdDeleteForever
              ...
              className="text-3xl cursor-pointer text-red-500 mt-2"
            />
          </div>
        </div>
      ))}
