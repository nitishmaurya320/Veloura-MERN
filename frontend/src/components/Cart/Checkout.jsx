    ...
    <div className="mt-[100px] h-full    ">
      ...
      <div className="md:flex-row md:text-[15px] text-[13px]  flex-wrap  flex  justify-center md:gap-6   p-5 md:h-full  items-center">
          ...
          <form onSubmit={handleCreateCheckout} className="">
            <div className="flex flex-col">
              ...
              <input
                ...
                className="border p-1 border-gray-400 rounded-md h-[35px] outline-gray-400"
              ></input>
            </div>
            <div>
              ...
              <div className="flex justify-between mt-2 gap-2">
                <div className="flex-col flex">
                  ...
                  <input
                    ...
                    className="border border-gray-400 rounded-md h-[35px] outline-gray-400 w-full p-2"
                  ></input>
                </div>
                <div className="flex-col flex">
              ...
              <div className="flex flex-col mt-2">
                ...
                <input
                  ...
                  className="border border-gray-400 rounded-md h-[35px] outline-gray-400 p-2"
                ></input>
              </div>
              <div className="flex justify-between mt-2 gap-2">
                <div className="flex-col flex">
                  ...
                  <input
                    ...
                    className="border border-gray-400 w-full rounded-md h-[35px] outline-gray-400 p-2"
                  ></input>
                </div>
                <div className="flex-col flex">
            ...
            <div className=" items-center justify-center mt-2    ">
              {!checkoutId ? (
                ...
                <div>
                  ...
                  <Razorpay
                    onPayClick={() => setIsPaymentDone(true)}
        ...
        <div className="md:w-[40%] md:h-full md:text-[15px] text-[12px] w-full shadow-md mb-5  bg-gray-50 mt-5 md:mt-0   p-4">
          <div>
            <h3 className="text-bold text-2xl mb-4">Order Summary</h3>
          </div>
          <div>
            {cart.products.map((item, index) => {
              return (
                <div
                  key={index}
                  className="flex  p-1 rounded bg-gray-200/40  justify-between mb-2"
                >
        ...
        <div className="flex items-center justify-center mt-2 md:hidden   "></div>
      </div>
    </div>
  );
};
